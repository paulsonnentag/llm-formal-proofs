import { check, CheckResult } from "./coqcheck";
...
export const TOOLS: ToolDefinition[] = [
  {
    ...
    function: {
      name: "check_proof",
      description:
        "Run Coq on the current proof tactics to see if they work. Returns success or detailed error messages including goal states.",
      parameters: {
        type: "object",
        properties: {},
        required: [],
...
function buildFullFile(state: ProofState): string {
  // Coq format: preamble + statement. Proof. tactics Qed.
  return `${state.preamble}\n\n${state.theoremStatement}.\nProof.\n${state.tactics}\nQed.\n`;
}
